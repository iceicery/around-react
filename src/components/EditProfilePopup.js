...
export default function EditProfilePopup({ isOpen, closeAllPopups, onUpdateUser }) {
    ...
    return (
        <PopupWithForm isOpen={isOpen} closeAllPopups={closeAllPopups} onSubmit={handleSubmit} name="edit" title="Edit profile" buttonText="Save">
